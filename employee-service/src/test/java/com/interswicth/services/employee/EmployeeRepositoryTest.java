package com.interswicth.services.employee;

import com.interswicth.services.employee.model.Employee;
import com.interswicth.services.employee.repository.EmployeeRepository;
...
public class EmployeeRepositoryTest {
    ...
    @Order(5)
    void testFindById() {
        Employee employee = repository.findEmployeeById(1L);
